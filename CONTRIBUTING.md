...
we use the git commit messages to **generate the [change log](https://github.com/tomastrajan/brew-frontend/blob/master/CHANGELOG.md)**.
...
Even more [examples](https://github.com/tomastrajan/brew-frontend/commits/master) of commit messages from commit history of this project.
